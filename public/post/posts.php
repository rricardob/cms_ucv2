                        ...
                        <tr>
                            ...
                            <td>
                                <i class="trash alternate icon btnDeletePost"
                                   ...
                                   style="color: red;" id="openModal"></i>
        ...
        <div class="description">
            <form class="ui form">
                ...
                <div class="field">
                    <label>Título</label>
                    <div class="field">
                        <input type="text" name="shipping[first-name]" placeholder="título del post">
                    </div>
                </div>
                <div class="field">
                    <label>Subtítulo</label>
                    <div class="field">
                        <input type="text" name="shipping[first-name]" placeholder="subtítulo del post">
                    </div>
                </div>
                <div class="three fields">
                    ...
                    <div class="field">
                        ...
                        <div class="ui fluid search selection dropdown">
                            ...
                            <div class="default text">selecione un estado</div>
                            <div class="menu">
                    ...
                    <div class="field">
                        ...
                        <div class="ui fluid search selection dropdown">
                            <input type="hidden" name="country">
                            <i class="dropdown icon"></i>
                            <div class="default text">seleccione un nivel</div>
                            <div class="menu">
                                <div class="item" data-value="af"><i class="af flag"></i>Afghanistan</div>
                                <div class="item" data-value="ax"><i class="ax flag"></i>Aland Islands</div>
                                <div class="item" data-value="al"><i class="al flag"></i>Albania</div>
                ...
                <div class="field">
                    <!--<label for="file" class="ui icon button">
                        <i class="file icon"></i>
                        Seleccione la imagen del post</label>
                    <input type="file" id="file" style="display:none">-->
                    <div class="ui action input">
                        <input type="text" id="_attachmentName" placeholder="Seleccione una imagen" readonly>
                        <label for="attachmentName" class="ui icon button btn-file">
                            <i class="attachment basic icon"></i>
                            <input type="file" accept="image/*" id="attachmentName" name="attachmentName" style="display: none">
                        </label>
                    </div>
                    <!--f-->

                </div>
                <h4 class="ui dividing header">Información del Post</h4>
                <div id="editor">
